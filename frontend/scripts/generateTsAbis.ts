...
const DEPLOYMENTS_DIR = "../backend/deployments";
const ARTIFACTS_DIR = "/Users/guihaihua/lumao/ZAMA/1014/backend/artifacts";
...
function getContractDataFromDeployments() {
  console.log("Resolved DEPLOYMENTS_DIR:", DEPLOYMENTS_DIR);
  console.log("Resolved ARTIFACTS_DIR:", ARTIFACTS_DIR);
  console.log("DEPLOYMENTS_DIR exists:", fs.existsSync(DEPLOYMENTS_DIR));
  console.log("ARTIFACTS_DIR exists:", fs.existsSync(ARTIFACTS_DIR));
